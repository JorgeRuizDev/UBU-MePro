...
public class ArbitroPartidasCompletasTest {
	...
	@Test
	void comprobarLegalidadDeMovimientosEnJaquePastor() {	
	...
	@Test
	void comprobarLegalidadDeMovimientosEnKARPOV_PARTIDA_2() {	
		assertThat("El número de jugadas iniciales debería ser 0", arbitro.obtenerNumeroJugada(),is(0));
	...
	@Test
	void comprobarLegalidadDeMovimientosEnALEKHINE_PARTIDA_8() {
		assertThat("El número de jugadas iniciales debería ser 0", arbitro.obtenerNumeroJugada(),is(0));
